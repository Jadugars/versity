    ...
    <div className="min-h-screen items-center justify-center  bg-gray-50 ml-20 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="my-2">
            ...
            <input
              ...
              type="string"
              required
              className="flex justify-center appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm"
