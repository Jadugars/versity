  ...
  return (
    ...
    <div className="md:flex bg-white h-screen rounded-lg p-24 justify-center">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-extrabold text-gray-900">What is Versity?
    {/* <br className="hidden lg:inline-block"></br>readymade gluten */}
          ...
          <div className="flex justify-center">
            <a href="/signup" onClick={signupClick} className="inline-flex text-white font-medium bg-green-600 border-0 py-2 px-6 focus:outline-none hover:bg-green-700 cursor-pointer rounded text-lg">Sign Up</a>
            <a href="/login" onClick={loginClick} className="ml-4 inline-flex text-gray-700 font-medium bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 cursor-pointer rounded text-lg">Sign In</a>
          </div>
        </div>
      </div>
    </div>
